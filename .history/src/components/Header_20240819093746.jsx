...
export const Header = () => {
  ...
  sx={{
    ...
    '& .MuiButton-root': {
      ...
      transition: 'background-color 0.4s, transform 0.4s, border-bottom 0.4s, border 0.4s',

      // Adicionando a animação e estilo dos botões
      '&:hover': {
        backgroundColor: 'var(--animation)',
        transform: 'scale(1.07)',
        borderBottom: '2px solid var(--hover-border-color)', // Risco embaixo
      },
      '&:active': {
        backgroundColor: 'var(--click)',
        border: '2px solid var(--click-border-color)', // Borda ao clicar
      },
    },
  }}
>
