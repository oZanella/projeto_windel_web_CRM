...
export const CardDados = ({
  ...
  return (
    <>
      <Box sx={{ display: 'flex', justifyContent: 'flex-end', mb: 2, mt: '64px', ml: { sm: '240px' } }}>
        <Button
          variant="contained"
          color="error"
      ...
      <TableContainer component={Paper} sx={{ overflowX: 'auto', marginTop: '64px', marginLeft: { sm: '240px' } }}>
        <Table size='small'>
          <TableHead>
            <TableRow>
