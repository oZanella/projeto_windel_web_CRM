...
export const CardDados = ({
  ...
  return (
    <>
      ...
      Dentro do TableContainer tem um calculo que é feito por conta do menu lateral*/}
      <TableContainer component={Paper} sx={{ overflowX: 'auto', width: { xs: '100%', sm: 'calc(100% - 250px)' }, ml: { sm: '250px' } }}>   
        <Table size='small'>
          <TableHead>
            <TableRow>
      ...
      <Dialog open={openModal} onClose={handleEditClose} fullWidth maxWidth="sm">
        ...
        <DialogActions>
          <Button onClick={handleEditClose} color="secondary" startIcon={<CloseIcon />}>
            Cancelar
          </Button>
